 ...
 * Author: Bryan Kim
 *
 * Objective: Implement the game of NIM, as a tournament
 */
#include <iostream>
#include <cmath>
...
void playTournament(int rounds) {
    ...
    for(int i=0; i<=rounds;i++){
        ...
        if(aGame == 0){
            ...
            cout << "Computer wins: " << compWins << ". Player wins: " << playerWins << endl;
        } else {
    ...
    if (compWins > playerWins) {
        cout << "The computer wins the tournament" << endl;
        cout << "Final Score - Computer wins: " << compWins << ". Player wins: " << playerWins << endl;
    } else {
        cout << "The player wins the tournament" << endl;
        cout << "Final Score - Computer wins: " << compWins << ". Player wins: " << playerWins << endl;
    }
}
